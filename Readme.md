...
После создания проекта вам доступны следующие сценарии. Обратите внимание, для запуска сценария, вы должны находится в директории проекта (`./backend` или `./frontend`).
...
25 часов - на Backend
35 часов - на Frontend

Frontend не доделан. Не готовы: фильтры, сортировка, пагинация. Не хватило времени, т.к. много времени ушло на восстановление знаний по React